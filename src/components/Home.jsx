        ...
        <div className="relative h-screen z-10 bg-white lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <main className="mx-auto max-w-7xl -translate-y-5 sm:px-6 lg:px-8">
            ...
            <span id='spandos' className="block text-center text-5xl drop-shadow-md text-yellow-500 shadow-black">MJC</span>
              ...
              Brindamos servicios integrales y asesoría en materia de higiene y seguridad. <br />Nuestro compromiso es brindar asistencia enfocándonos en la detección temprana de sus necesidades, conociendo las variables de un mercado que propone cambios constantes nos comprometemos a adaptarnos para lograr una buena relación costo-beneficio. <br />Creemos en el desarrollo de vínculos sólidos entre profesional y cliente que conduzcan a la mejora continúa de su organización.
              </p>
