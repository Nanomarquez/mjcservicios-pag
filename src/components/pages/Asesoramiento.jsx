  ...
  return (
    <>
      <div className='flex flex-col sm:flex-row items-center gap-10 justify-center text-center bg-amber-500/70 w-screen h-[65%] absolute'>
        <div className='w-[80%] sm:w-1/3 sm:border-r-2 border-b-2 sm:border-b-0 pb-5 font-bold text-lg drop-shadow-md'>
          <ul>
            <li>Servicios externos en HyS</li>
            <li>Estudio antisiniestral</li>
            <li>Programas de seguridad en obras</li>
            <li>Capacitacion para conductores de autoelevadores RES. 960/15</li>
          </ul>
        </div>
        <div className='w-[80%] sm:w-1/3 sm:border-r-2 border-b-2 sm:border-b-0 pb-5 font-bold text-lg drop-shadow-md'>
        <ul>
            <li>Planes de emergencia y evacuacion</li>
            <li>Formacion y capacitacion de brigadas</li>
            <li>Analisis de riesgos</li>
            <li>Auditorias internas para la gestion de SST. /150 45.001/18</li>
          </ul>
        </div>
        <div className='w-full sm:w-1/3 font-bold text-lg drop-shadow-md'>
        <ul>
            <li>Investigacion de accidentes, gestion de estadisticas</li>
            <li>Supervision tecnica para tareas de riesgo</li>
            <li>Visitas tecnicas/ART</li>
