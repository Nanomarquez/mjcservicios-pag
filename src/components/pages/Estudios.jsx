    ...
    <>
      <div className='flex flex-col sm:flex-row items-center gap-10 justify-center text-center bg-amber-500/70 w-screen h-[65%] absolute'>
        <div className='w-[80%] sm:w-1/3 sm:border-r-2 border-b-2 sm:border-b-0 pb-5 font-bold text-lg drop-shadow-md'>
          <ul>
            <li>Ruido laboral SRT 85/12</li>
            <li>Iluminación SRT 84/12</li>
            <li>Contaminacion luminica</li>
          </ul>
        </div>
        <div className='w-[80%] sm:w-1/3 sm:border-r-2 border-b-2 sm:border-b-0 pb-5 font-bold text-lg drop-shadow-md'>
        <ul>
            <li>Ruidos molestos IRAM 6042</li>
            <li>Puesta a tierra y continuidad SRT 900/15</li>
        ...
        <ul>
            ...
            <li>Analisis fisico, quimico y bacteorologico para agua</li>
          </ul>
        </div>
      </div>
